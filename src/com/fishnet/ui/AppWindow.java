...
public class AppWindow {
	...
	public void populateURLBox() {
		DefaultComboBoxModel<Object> model = new DefaultComboBoxModel<Object>(Fishnet.usedHosts.toArray());
	...
	private void initialize() {
		...
		frmFishnet.setTitle("Analizador web de "+Fishnet.APP_NAME);
